...
module Core::Pages
  RSpec.describe PagesController do
    describe 'GET show' do
      ...
      let!(:thatsite_first_page) { FactoryBot.create(:page, name: 'home', site: thatsite) }
      let(:a_second_site) { FactoryBot.create(:site, name: 'second-site') }
      let!(:a_second_site_first_page) { FactoryBot.create(:page, name: 'home', site: a_second_site) }
      before do
